<div id="filemanager" class="modal-dialog modal-lg">
  <div class="modal-content">
    <div class="modal-header">
      ...
      <h4 class="modal-title"><?php echo $c . $heading_title; ?></h4>
    </div>
...
$('#button-search').on('click', function(e) {
	var url = '<?php echo site_url("common/filemanager"); ?>?token=<?php echo $token; ?>&directory=<?php echo $directory; ?>';
...
$('#button-folder').on('shown.bs.popover', function() {
	$('#button-create').on('click', function() {
		$.ajax({
			url: '<?php echo site_url("common/filemanager"); ?>/folder?token=<?php echo $token; ?>&directory=<?php echo $directory; ?>',
			type: 'post',
			dataType: 'json',
...
$('#modal-image #button-delete').on('click', function(e) {
	if (confirm('<?php echo $text_confirm; ?>')) {
		$.ajax({
			url: '<?php echo site_url("common/filemanager"); ?>/delete?token=<?php echo $token; ?>',
			type: 'post',
			dataType: 'json',
