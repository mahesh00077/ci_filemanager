...
<div id="container">
	...
	<div>
		<a href="" id="profile-image" data-toggle="image" class="img-thumbnail"><img src="<?php echo $thumb; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="profile" value="<?php echo $image; ?>" id="input-image" />
	</div>
